...
public class LiquidacionEntity {
    ...
    public LiquidacionEntity(Integer id, OffsetDateTime fecha, BigDecimal valor, TrabajadorEntity idTrabajadorEntity, EstadoLiquidacionEntity idEstadoLiquidacionEntity) {
        this.id = id;
        this.fecha = fecha;
        this.valor = valor;
